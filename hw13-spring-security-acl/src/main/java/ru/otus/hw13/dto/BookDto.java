...
public class BookDto {
    ...
    private final Boolean ageRestrict;
    @NotNull(message = "Выберите жанр(ы).")

    private final List<GenreDto> genres;
    private final List<CommentDto> comments;

    public BookDto(Long id, AuthorDto author, String title, String shortContent, Boolean ageRestrict, List<GenreDto> genres, List<CommentDto> comments) {
        this.id = (id == null ? 0L : id);
        this.author = author;
        this.title = title;
        this.shortContent = shortContent;
        this.ageRestrict = ageRestrict == null ? false : ageRestrict;
        this.genres = genres;
    ...
    public Book toEntity() {
        ...
        return new Book(id, author.toEntity(), title, shortContent, ageRestrict, genreEntities, null);
    }
    ...
    public static BookDto fromEntityEager(Book bookEntity) {
        ...
        return new BookDto(bookEntity.getId(), AuthorDto.fromEntity(bookEntity.getAuthor()),
                bookEntity.getTitle(), bookEntity.getShortContent(), bookEntity.isAgeRestrict(), genresDto, commentsDto);
    }
    ...
    public static BookDto fromEntityLazy(Book bookEntity) {
        val genresDto = bookEntity.getGenres()
                ...
                .collect(Collectors.toList());
        return new BookDto(bookEntity.getId(), AuthorDto.fromEntity(bookEntity.getAuthor()),
                bookEntity.getTitle(), bookEntity.getShortContent(), bookEntity.isAgeRestrict(), genresDto, new ArrayList<>());
    }
}
