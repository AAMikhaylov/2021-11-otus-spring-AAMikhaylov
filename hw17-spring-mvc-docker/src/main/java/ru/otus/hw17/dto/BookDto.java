...
import lombok.val;
import ru.otus.hw17.controllers.deserializer.AuthorDeserializer;
import ru.otus.hw17.controllers.deserializer.GenresDeserializer;
...
public class BookDto {
    ...
    @JsonDeserialize(converter = AuthorDeserializer.class)
    ...
    @JsonDeserialize(converter = GenresDeserializer.class)
